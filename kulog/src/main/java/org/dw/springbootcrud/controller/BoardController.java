...
public class BoardController {
    ...
    public ResponseEntity<PageResponseDTO<BoardDTO>> listByUserId(@PathVariable String uuid, PageRequestDTO pageRequestDTO) {

       return ResponseEntity.ok( boardService.getBoardListByWriter(uuid, pageRequestDTO));
    }
